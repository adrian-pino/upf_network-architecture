# Table of Contents — Blocks 4 & 5 (with content bullet points)

**Overarching questions these blocks answer:**
...
### Session 1 (única): SDN, NFV, Containers & Trends (5.1–5.6)
...
- ~~Quantum Computing~~ → removed per agreed recommendations
- ~~AI/ML in Cloud Networking~~ → removed (too speculative for this level)
