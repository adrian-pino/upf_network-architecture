...
- The VLAN Scalability Problem (12-bit ID, 4096 limit, L2 domain)
- Overlay Networks: Concept (encapsulation, outer headers)
...
- Container Networking — Visual (TikZ: two hosts with bridge + overlay)
